                ...
                <div class="step-content">
                    ...
                    ${step.appStoreLinks && step.appStoreLinks.length > 0 ? `
                        <div class="step-app-store-links">
                            <span class="step-app-store-label">Mobile Apps</span>
                            ${step.appStoreLinks.map(group => `
                                <div class="step-app-store-row">
                                    <span class="step-app-store-app-name">${group.appName}</span>
                                    ${group.links.map(link => `
                                        <a href="${link.url}" class="step-app-store-btn step-app-store-btn--${link.store}" target="_blank" rel="noopener noreferrer">
                                            ${link.store === 'apple' ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>` : `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" fill="currentColor"><path d="M3.18 23.76c.3.17.64.22.97.15l12.45-7.19-2.77-2.77-10.65 9.81zM.58 1.28C.22 1.64 0 2.22 0 2.96v18.08c0 .74.22 1.32.59 1.67l.09.08 10.13-10.13v-.24L.67 1.2l-.09.08zM20.46 10.5l-2.85-1.65-3.11 3.11 3.11 3.11 2.87-1.66c.82-.47.82-1.24-.02-1.71zM3.18.24L15.63 7.43l-2.77 2.77L.21.39C.54.32.88.07 3.18.24z"/></svg>`}
                                            ${link.label}
                                        </a>
                                    `).join('')}
                                </div>
